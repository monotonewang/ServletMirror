 ...
 */
@WebServlet(name = "ServletMvpLogin")
public class ServletMvpLogin extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(succUser == null){
                ...
                request.getRequestDispatcher("/jsp/mvpdemo/login.jsp").forward(request, response);
            }else{
                // 完成记住用户名的功能
                // 获取复选框的内容
