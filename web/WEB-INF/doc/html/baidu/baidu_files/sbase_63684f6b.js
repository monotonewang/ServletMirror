...
baidu.dom.getPosition = function (a) {
    a = baidu.dom.g(a);
    var l = baidu.dom.getDocument(a), d = baidu.browser, i = baidu.dom.getStyle, c = d.isGecko > 0 && l.getBoxObjectFor && i(a, "position") == "absolute" && (a.style.top === "" || a.style.left === ""), j = {
        left: 0,
        top: 0
...
(function () {
    var d = baidu.browser, m = {keydown: 1, keyup: 1, keypress: 1}, a = {
        click: 1,
        dblclick: 1,
        mousedown: 1,
        mousemove: 1,
...
(function (m, f) {
    ...
    function l(t, q, v, s) {
        ...
        if (q == "css") {
            r.rel = "stylesheet";
            r.href = t;
            if (typeof pageState == "undefined" || pageState == 0) {
                p.appendChild(r)
            } else {
                window.index_links.push(r);
                u && clearTimeout(u)
            }
        } else {
    ...
    j.prototype = {
        domain: s_domain, session: s_session, use: function (q, p) {
            if (typeof q === "string") {
                q = [q]
            }
...
F.module("lib/log", function (n, u, r) {
    ...
    var j = {
        ...
        msg: 2,
        res: 2
    }, i = {}, p = s_session.usertype, q = (s_session.userTips.isNewVersion ? "pack" : "classic"), o = s_session.portrait, d = s_session.logId || "0", m = 0, g = {};
    var s = function (x, w) {
        var v = {
            mod: x,
            submod: w || "",
...
F.use("lib/sbase", function (a) {
    var b = a.Class.create(function (c) {
        ...
        f.load = function (k, l, i) {
            ...
            a.ajax.request(j, {
                method: "GET", onsuccess: function (p, o) {
                    if (o) {
                        try {
        ...
        f.remove = function (k, m) {
            var j = [], l = [], i = [];
            a.forEach(k, function (n) {
                j.push(n.id);
                l.push(n.optype);
                if (n.layout) {
                    i.push(n.layout)
            ...
            if (i.length > 0) {
                g(c.remove, {id: j.join(","), optype: l.join(","), layout: i.join(",")}, m)
            } else {
                g(c.remove, {id: j.join(","), optype: l.join(",")}, m)
            }
        }
    });
    a.UIM = a.UIM || {};
...
F.module("common/user_attr", function (b, f, n) {
    ...
    var g = function (v, p) {
        ...
        if (u > 0) {
            if (l) {
                d.post(s_domain.baseuri + k.SUBMIT_STATUS[c.name], {
                    prop: r.join(","),
                    value: t.join(",")
                }, function (y) {
                    if (y.errNo == 0) {
